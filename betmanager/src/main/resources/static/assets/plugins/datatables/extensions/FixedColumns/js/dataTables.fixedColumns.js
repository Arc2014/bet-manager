...
FixedColumns.prototype = /** @lends FixedColumns.prototype */{
	 ...
	 *      var fc = new $.fn.dataTable.fixedColumns( table );
	 *
	 *      // Resize the table container and then have FixedColumns adjust its master....
	 *      $('#content').width( 1200 );
	 *      fc.fnRedrawLayout();
	 */
	...
	"_fnConstruct": function ( oInit )
	{
		...
		/* Set up the DOM that we want for the fixed column master grid */
		this._fnColCalc();
		this._fnGridSetup();
	...
	/**
	 * Calculate the column widths for the grid master
	 *  @returns {void}
	 *  @private
	 */
	"_fnColCalc": function ()
	...
	/**
	 * Set up the DOM for the fixed column. The way the master works is to create a 1x3 grid
	...
	/**
	 * Style and position the grid used for the FixedColumns master
	 *  @returns {void}
	 *  @private
	 */
	...
	/**
	 * Make a copy of the master object for a header or footer element from DataTables. Note that
	 * this method will clone the nodes in the master object.
	 *  @returns {Array} Copy of the master array
	...
	"_fnClone": function ( oClone, oGrid, aiColumns, bAll )
	{
		...
		if ( bAll )
		{
			...
			/* Copy the DataTables master cache for the header for our floating column */
		...
		else
		{
			 ...
			 * cloned cells, just copy the classes across. To get the matching master for the
